...
//
//This project create a voice-like sound and environmental sound only using four kinds of Oscillator and 6 Oscillator in total for phase modualtion, It sounds like that two man is talking and arguing with each other.
